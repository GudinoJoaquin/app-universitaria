    ...
    <LinearGradient colors={["#0f172a", "#1e3a8a", "#3b82f6"]} style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          {/* Formulario */}
          <View style={{ backgroundColor: "white", borderRadius: 24, padding: 24, shadowColor: "#000", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 15, elevation: 10 }}>
            <Text style={{ fontSize: 24, fontWeight: "bold", color: "#1F2937", marginBottom: 24, textAlign: "center" }}>
              Bienvenido de nuevo
            </Text>
            ...
            <TouchableOpacity
              style={[
                ...
                (isLoading || !email || !password || !/\S+@\S+\.\S+/.test(email)) && { backgroundColor: "#93C5FD", opacity: 0.8 }
              ]}
              onPress={handleLogin}
              disabled={isLoading || !email || !password || !/\S+@\S+\.\S+/.test(email)}
            >
              {isLoading ? (
                <ActivityIndicator color="white" size="small" />
              ) : (
                <>
                  <Text style={{ color: "white", fontSize: 18, fontWeight: "bold", marginRight: 8 }}>Ingresar</Text>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 24 }}>
              ...
              <Text style={{ marginHorizontal: 16, color: "#9CA3AF", fontWeight: "500" }}>O continúa con</Text>
              <View style={{ flex: 1, height: 1, backgroundColor: "#E5E7EB" }} />
            </View>
            ...
            <View style={{ flexDirection: "row", justifyContent: "center", marginTop: 32 }}>
              <Text style={{ color: "#6B7280", fontSize: 14 }}>¿No tienes cuenta? </Text>
              <TouchableOpacity onPress={() => navigation.navigate("Register")} disabled={isLoading}>
                <Text style={{ color: "#2563EB", fontSize: 14, fontWeight: "bold" }}>Regístrate aquí</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
