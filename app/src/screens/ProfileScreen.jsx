...
const s = StyleSheet.create({
  ...
  hero: { alignItems: "center", paddingTop: 70, paddingBottom: 40, paddingHorizontal: 20, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, elevation: 15, shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 20 },
